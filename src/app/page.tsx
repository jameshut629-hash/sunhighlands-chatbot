  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Sunhighlands Australia Chatbot</title>
        <link rel="icon" href="https://www.sunhighlands.com.au/cdn/shop/files/logo.png" />
      </head>
      <body style={{ margin: 0, padding: 0, background: '#fffbeb', fontFamily: 'Poppins, sans-serif', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
